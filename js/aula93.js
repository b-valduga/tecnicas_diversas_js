...
document.querySelector('#btn_validar').addEventListener('click', (evt) =>{
    let msg = null; //para guardar as mensagens

    if(!f_nota.checkValidity()) { //retorna a msg de validaçao padrão caso a validação não atender os requisitos
        msg = f_nota.validationMessage;
    }

    f_msg.innerHTML = msg;
    evt.preventDefault(); //não irá executar o submit quando o botão for clicado
})
